...
/**
 * @file
 * Contains Drupal\custom_entity_types\Form\MultiStepForm.
 */
...
public function submitForm(array &$form, FormStateInterface $form_state)
{
  ...
  $form_values['color'] = $form_state->getValue('color');

  \Drupal::messenger()->addMessage('The values submitted are:'. print_r($form_values, TRUE));

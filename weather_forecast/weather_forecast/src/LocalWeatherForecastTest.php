...
namespace Drupal\weather_forecast\Tests;

use Drupal\weather_forecast\WebTestBase;

/**
 * Tests for the weather_forecast module.
 *
...
class LocalWeatherForecastTest extends WebTestBase {
   ...
   * {@inheritdoc}
   */
  public static $modules = ['weather_forecast'];
  ...
  public function testConfigForm() {
    ...
    $this->drupalGet('admin/config/system/forecast');
    $this->assertResponse(200);
    $config = $this->config('weather_forecast.settings');
